...
import 'package:neuro_task_mosaic/resource/text_field/my_text_field.dart';
import 'package:neuro_task_mosaic/view/auth/pages/sign_up.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      setState(() {
                        loginViewModel.firebaseLogin(email.text, password.text).whenComplete((){
                          setState(() {
                    ...
                    child: Container(
                      ...
                      child: (loginViewModel.isLoading.value) ? const Center(child: CircularProgressIndicator(color: Colors.white,)) :
